...
type Props = {
  path: string;
  /** Strapi `slug` when it differs from the last segment of `path`. */
  cmsSlug?: string;
  title: string;
  description: string;
...
export async function ConversionCalculatorPageLayout({
  path,
  cmsSlug,
  title,
  description,
  ...
  return (
    <div className="w-full min-w-0">
      ...
      <Breadcrumbs
        ...
        items={[
          { label: "home", href: "/" },
          { label: "conversion calculator", href: "/conversion" },
