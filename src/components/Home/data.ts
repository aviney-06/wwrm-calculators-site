...
export const homeCategorySections: HomeCategorySectionData[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Auto Loan Calculator", href: "/finance/auto-loan-calculator" },
      { label: "Retirement Calculator", href: "/finance/retirement-calculator" },
      { label: "Compound Interest Calculator", href: "/finance/compound-interest-calculator" },
