...
export function TDEE_Calculator() {
  ...
  const run = () => {
    ...
    const total = Math.round(bmr * mult);
    setTdee(total);
  ...
  const form = (
    <div className="flex flex-1 flex-col gap-3 sm:gap-4 md:gap-6">
      <AgeGenderRow
        ...
        ageMin={15}
        ageMax={100}
        ageHint="Used for Mifflin–St Jeor equation."
      />
      <UnitsRow
        label="Units"
        selectId="tdee-units"
    ...
    tdee != null ? (
      <>
        ...
        <p className="max-w-[15rem] text-center text-[12px] text-[#64748b]">
          Total Daily Energy Expenditure (estimate). Not medical advice.
        </p>
      </>
    ) : (
