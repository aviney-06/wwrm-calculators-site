...
import { leanBodyMassBoer } from "../shared/bodyComposition";

type Unit = "imperial" | "metric";
type Gender = "male" | "female";

export function LeanBodyMass_Calculator() {
  ...
  const run = () => {
    ...
    const v = leanBodyMassBoer(wKg, hCm, gender === "male");
    if (!Number.isFinite(v) || v <= 0) {
      setError("Check inputs — lean mass should be positive.");
      setLbm(null);
      return;
    }
    setLbm(Math.round(v * 10) / 10);
